...
| **Виключні ситуації**| Неправильні або неповні дані.<br> Проблеми з сервером.<br> Користувач вже зареєстрований. |
...
| **Виключні ситуації**| Неправильні облікові дані.<br> Забутий пароль.<br> Проблеми з доступом до сервера.<br> Користувач не зареєстрований. |
...
| **Виключні ситуації**| Відсутність відповідей для аналізу, технічні проблеми з відображенням результатів.     |
...
### Процес 4: Створення нової форми опитування
...
| **Виключні ситуації**| Помилки при збереженні.<br> Неповна інформація при заповненні форми.<br> Проблеми із сервером.|
...
### Процес 5: Редагування існуючої форми опитування
...
| **Виключні ситуації**| Конфлікти версій при редагуванні.<br> Помилки під час збереження змін.| 
...
### Процес 6: Публікація форми опитування
...
| **Виключні ситуації**| Недоступність сервера під час публікації.<br> Відсутність прав на публікацію.| 
